...
public class JSONAddPortMsg extends JSONMsg {
	...
	*/
	public JSONAddPortMsg(String name, String localIPAddr, String remoteIPAddr, OVSDBImpl tsw, int messageId, boolean capwap) throws OVSDBBridgeUnknown {
	...
	private String inserts() throws OVSDBBridgeUnknown {
		...
		String mid = "\",\"op\":\"insert\",\"table\":\"Port\",\"row\":" + "{\"interfaces\":[\"named-uuid\",\"";
