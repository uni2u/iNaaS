...
public class State extends OFModel {
	...
	public List<OFFlowStatsEntry> getFlowStates(Long switchId, Match match) {
		...
		HashMap<String, List<OFFlowStatsEntry>> result = new HashMap<String, List<OFFlowStatsEntry>>();
		List<OFFlowStatsEntry> resultValues = new java.util.LinkedList<OFFlowStatsEntry>();
		result.put(Long.toHexString(switchId), resultValues);
